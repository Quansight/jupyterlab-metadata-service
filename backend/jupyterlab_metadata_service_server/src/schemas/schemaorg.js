...
const DataDownload = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    requiresSubscription: { type: GraphQLList(requiresSubscription) },
...
const height = new GraphQLUnionType({
  name: 'height',
  types: [].concat(
    Object.values(QuantitativeValue),
...
const requiresSubscription = new GraphQLUnionType({
  name: 'requiresSubscription',
  types: [].concat(
    Object.values(MediaSubscription),
    Object.values(GraphQLBoolean),
  ),
  resolveType(value) {
    return value.__typename;
  }
...
const areaServed = new GraphQLUnionType({
  name: 'areaServed',
  types: [].concat(
    Object.values(AdministrativeArea),
    Object.values(GeoShape),
    Object.values(Place),
  ),
  resolveType(value) {
    return value.__typename;
...
const memberOf = new GraphQLUnionType({
  name: 'memberOf',
  types: [].concat(
    Object.values(ProgramMembership),
    Object.values(Organization),
  ),
  resolveType(value) {
    return value.__typename;
...
const category = new GraphQLUnionType({
  ...
  types: [].concat(
    Object.values(Thing),
    Object.values(PhysicalActivityCategory),
  ),
  resolveType(value) {
    return value.__typename;
  }
...
const interactionService = new GraphQLUnionType({
  ...
  types: [].concat(
    ...
    Object.values(SoftwareApplication),
  ),
  resolveType(value) {
    return value.__typename;
  }
...
const geoContains = new GraphQLUnionType({
  name: 'geoContains',
  types: [].concat(
    Object.values(GeospatialGeometry),
    Object.values(Place),
  ),
  resolveType(value) {
    return value.__typename;
...
const photo = new GraphQLUnionType({
  name: 'photo',
  types: [].concat(
    Object.values(ImageObject),
    Object.values(Photograph),
  ),
  resolveType(value) {
    return value.__typename;
  }
...
const value = new GraphQLUnionType({
  name: 'value',
  types: [].concat(
    Object.values(StructuredValue),
    Object.values(GraphQLBoolean),
  ),
  resolveType(value) {
    return value.__typename;
...
const valueReference = new GraphQLUnionType({
  ...
  types: [].concat(
    ...
    Object.values(QuantitativeValue),
    Object.values(StructuredValue),
    Object.values(QualitativeValue),
  ),
  resolveType(value) {
    return value.__typename;
  }
...
const alumniOf = new GraphQLUnionType({
  name: 'alumniOf',
  types: [].concat(
    Object.values(EducationalOrganization),
    Object.values(Organization),
  ),
  resolveType(value) {
    return value.__typename;
...
const netWorth = new GraphQLUnionType({
  name: 'netWorth',
  types: [].concat(
    Object.values(PriceSpecification),
    Object.values(MonetaryAmount),
  ),
  resolveType(value) {
    return value.__typename;
  }
...
const SchemaOrgTypeDef = { Enumeration, DataDownload, DayOfWeek, DataCatalog, Audience, WarrantyScope, VideoObject, Episode, NewsArticle, PriceSpecification, BroadcastChannel, OfferItemCondition, SoftwareApplication, Answer, AdministrativeArea, Photograph, Country, EducationalOccupationalCredential, LoanOrCredit, LocationFeatureSpecification, GeoCoordinates, MusicAlbumReleaseType, BreadcrumbList, ContactPointOption, Review, QualitativeValue, CreativeWorkSeries, Distance, Event, TypeAndQuantityNode, MusicComposition, ItemList, ProductModel, Organization, PhysicalActivityCategory, StructuredValue, Comment, BroadcastService, EventStatusType, ActionStatusType, Offer, InteractionCounter, BusinessEntityType, Clip, Property, Place, OpeningHoursSpecification, DefinedTermSet, MusicPlaylist, PublicationEvent, MediaSubscription, MonetaryAmount, Person, PostalAddress, QuantitativeValue, EntryPoint, OfferCatalog, Service, Dataset, AudioObject, Question, CorrectionComment, ListItem, MusicRelease, AboutPage, SpeakableSpecification, MediaObject, Occupation, MusicRecording, WebSite, Demand, ServiceChannel, DeliveryMethod, MusicAlbum, AlignmentObject, ImageObject, Map, MusicAlbumProductionType, BroadcastFrequencySpecification, BusinessFunction, EducationalOrganization, MusicGroup, Product, ProgramMembership, MonetaryAmountDistribution, WarrantyPromise, CreativeWork, Class, DataFeed, DefinedTerm, AggregateRating, ItemAvailability, Article, Language, Action, WebPageElement, GenderType, Specialty, ItemListOrderType, PaymentMethod, Thing, CableOrSatelliteService, GeoShape, RepaymentSpecification, OwnershipInfo, GeospatialGeometry, Brand, Duration, CreativeWorkSeason, MapCategoryType, MusicReleaseFormatType, ContactPoint, DataFeedItem, Rating };
module.exports = SchemaOrgTypeDef;
